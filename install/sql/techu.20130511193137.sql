...
INSERT INTO `sp_configurations` VALUES (9,'test','b1a4f059a55cf2f63e7996fe06adf199','',1,NULL,'2013-04-27 14:06:11');
...
CREATE TABLE `sp_index_option` (
  ...
  `date_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `sp_index_id` (`sp_index_id`,`sp_option_id`)
...
INSERT INTO `sp_index_option` VALUES (1,23,53,'title',1,NULL,'2013-05-07 07:23:53'),(2,23,53,'content',1,NULL,'2013-05-07 07:24:02'),(3,23,3,'/usr/local/sphinx/data/rt',1,NULL,'2013-05-07 07:24:26'),(4,23,1,'rt',1,NULL,'2013-05-07 07:24:45'),(5,23,54,'gid',1,NULL,'2013-05-07 07:25:11');
...
CREATE TABLE `sp_searchd_option` (
  ...
  `date_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `sp_searchd_id` (`sp_searchd_id`,`sp_option_id`)
...
INSERT INTO `sp_searchd_option` VALUES (1,1,138,'9312',1,NULL,'2013-05-07 07:18:33'),(2,1,138,'9306:mysql41',1,NULL,'2013-05-08 20:17:47'),(3,1,141,'/var/log/sphinxsearch/searchd.log',1,NULL,'2013-05-07 07:21:02'),(4,1,142,'/var/log/sphinxsearch/query.log',1,NULL,'2013-05-07 07:21:10'),(5,1,165,'threads',1,NULL,'2013-05-07 07:21:32'),(6,1,147,'/var/run/searchd.pid',1,NULL,'2013-05-07 07:21:57'),(7,1,148,'1000',1,NULL,'2013-05-07 07:22:10');
...
CREATE TABLE `sp_source_option` (
  ...
  `date_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `sp_source_id` (`sp_source_id`,`sp_option_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-11 19:31:37
